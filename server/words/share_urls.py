...
urlpatterns = patterns('words.views',
    ...
    (r'^prompt/(?P<prompt>\d+)/hand/' + card_id_capture(CARDS_IN_HAND) + 'after/$', 'share_hand_after'),
    ...
    (r'^prompt/(?P<prompt>\d+)/groupchoices/' + card_id_capture(2) + 'after/$', 'share_groupchoices_after'),
    (r'^prompt/(?P<prompt>\d+)/groupchoices/' + card_id_capture(3) + '$', 'share_groupchoices'),
    (r'^prompt/(?P<prompt>\d+)/groupchoices/' + card_id_capture(3) + 'after/$', 'share_groupchoices_after'),
    (r'^prompt/(?P<prompt>\d+)/groupchoices/' + card_id_capture(4) + '$', 'share_groupchoices'),
    (r'^prompt/(?P<prompt>\d+)/groupchoices/' + card_id_capture(4) + 'after/$', 'share_groupchoices_after'),
    (r'^prompt/(?P<prompt>\d+)/groupchoices/' + card_id_capture(5) + '$', 'share_groupchoices'),
    (r'^prompt/(?P<prompt>\d+)/groupchoices/' + card_id_capture(5) + 'after/$', 'share_groupchoices_after'),
    (r'^prompt/(?P<prompt>\d+)/groupchoices/' + card_id_capture(6) + '$', 'share_groupchoices'),
    (r'^prompt/(?P<prompt>\d+)/groupchoices/' + card_id_capture(6) + 'after/$', 'share_groupchoices_after'),
    (r'^prompt/(?P<prompt>\d+)/groupchoices/' + card_id_capture(7) + '$', 'share_groupchoices'),
    (r'^prompt/(?P<prompt>\d+)/groupchoices/' + card_id_capture(7) + 'after/$', 'share_groupchoices_after'),
    (r'^prompt/(?P<prompt>\d+)/groupchoices/' + card_id_capture(8) + '$', 'share_groupchoices'),
    (r'^prompt/(?P<prompt>\d+)/groupchoices/' + card_id_capture(8) + 'after/$', 'share_groupchoices_after'),
    (r'^prompt/(?P<prompt>\d+)/groupchoices/' + card_id_capture(9) + '$', 'share_groupchoices'),
    (r'^prompt/(?P<prompt>\d+)/groupchoices/' + card_id_capture(9) + 'after/$', 'share_groupchoices_after'),
    (r'^prompt/(?P<prompt>\d+)/groupchoices/' + card_id_capture(10) + '$', 'share_groupchoices'),
    (r'^prompt/(?P<prompt>\d+)/groupchoices/' + card_id_capture(10) + 'after/$', 'share_groupchoices_after'),
    (r'^prompt/(?P<prompt>\d+)/groupchoices/' + card_id_capture(11) + '$', 'share_groupchoices'),
    (r'^prompt/(?P<prompt>\d+)/groupchoices/' + card_id_capture(11) + 'after/$', 'share_groupchoices_after'),
    (r'^prompt/(?P<prompt>\d+)/groupchoices/' + card_id_capture(12) + '$', 'share_groupchoices'),
    (r'^prompt/(?P<prompt>\d+)/groupchoices/' + card_id_capture(12) + 'after/$', 'share_groupchoices_after'),
    (r'^prompt/(?P<prompt>\d+)/groupchoices/' + card_id_capture(13) + '$', 'share_groupchoices'),
    (r'^prompt/(?P<prompt>\d+)/groupchoices/' + card_id_capture(13) + 'after/$', 'share_groupchoices_after'),
    (r'^prompt/(?P<prompt>\d+)/groupchoices/' + card_id_capture(14) + '$', 'share_groupchoices'),
    (r'^prompt/(?P<prompt>\d+)/groupchoices/' + card_id_capture(14) + 'after/$', 'share_groupchoices_after'),
    (r'^prompt/(?P<prompt>\d+)/groupchoices/' + card_id_capture(15) + '$', 'share_groupchoices'),
    (r'^prompt/(?P<prompt>\d+)/groupchoices/' + card_id_capture(15) + 'after/$', 'share_groupchoices_after'),
    (r'^prompt/(?P<prompt>\d+)/groupchoices/' + card_id_capture(16) + '$', 'share_groupchoices'),
    (r'^prompt/(?P<prompt>\d+)/groupchoices/' + card_id_capture(16) + 'after/$', 'share_groupchoices_after'),
    (r'^prompt/(?P<prompt>\d+)/groupchoices/' + card_id_capture(17) + '$', 'share_groupchoices'),
    (r'^prompt/(?P<prompt>\d+)/groupchoices/' + card_id_capture(17) + 'after/$', 'share_groupchoices_after'),
    (r'^prompt/(?P<prompt>\d+)/groupchoices/' + card_id_capture(18) + '$', 'share_groupchoices'),
    (r'^prompt/(?P<prompt>\d+)/groupchoices/' + card_id_capture(18) + 'after/$', 'share_groupchoices_after'),
